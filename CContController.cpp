...
bool CContController::Update()
{
	...
	else
	{
		...
		//PRINT TO CONSOLE//
		std::cout << "\n======================================\n	--> ITERATION: " << m_iIterations << " <--	\n======================================\n" << std::endl;
		std::cout << "Deaths:  " << deaths << "/" << m_vecSweepers.size() << std::endl;
		std::cout << "Number of mines collected: " << sum << std::endl;
		//std::cout << "Average mines collected:  " << sum / float(m_vecSweepers.size()) << std::endl;
		//std::cout << "Max mines collected:  " << maxMines << std::endl;
